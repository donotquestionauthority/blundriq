...
describe("Home page", () => {
  it("shows the day's numbers, the streaks, and links the new blunders with the visit boundary", async () => {
    ...
    expect(screen.getByText(/Last looked/)).toBeInTheDocument();
  ...
  it("marks a met target as done and a first visit as such", async () => {
    stub(page({ since: null, puzzles: { due: 0, solved_today: 10, target: 10, streak: 1 }, games: { today: 1, week: 1, target: 1, streak: 1 } }));
    renderPage();
